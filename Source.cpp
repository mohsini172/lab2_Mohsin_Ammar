...
void test(int mat1Rows, int mat1cols, int mat2Rows , int mat2cols ){
	int i_matSize = 64;
	if (i_matSize < 2) {
		i_matSize = 2;
	}
	...
	int resultRows = 0;
	int resultCols = 0;
	if (mat1Rows >= mat1Rows && mat1Rows >= mat2Rows &&  mat1Rows >= mat1cols && mat1Rows >= mat2cols){
		resultRows = mat1Rows;
	}
	else if (mat2Rows >= mat1Rows && mat2Rows >= mat2Rows &&  mat2Rows >= mat1cols && mat2Rows >= mat2cols){
		resultRows = mat2Rows;
	}
	else if (mat1cols >= mat1Rows && mat1cols >= mat2Rows &&  mat1cols >= mat1cols && mat1cols >= mat2cols)
		resultRows = mat1cols;
	else
		resultRows = mat2cols;
	resultRows--;
	...
	resultRows |= resultRows >> 4;
	resultRows |= resultRows >> 8;
	resultRows |= resultRows >> 16;
	resultRows++;
	/*resultRows = log2(resultRows)+1;*/
	resultCols = resultRows;
	
	//cout<<resultRows<<"x"<<resultCols<<endl;
	int **inputMat1 = new int *[resultRows];

	int **inputMat2 = new int *[resultRows];
	int **resultMat = new int *[resultRows];
	int **resultMatStras = new int *[resultRows];


	cout << "first Matrix" << endl;
	pad(inputMat1, resultRows);
	initMat(inputMat1, mat1Rows, mat1cols);
	cout << "first Matrix display" << endl;
	displayMat(inputMat1, resultRows, resultRows);
	cout << "second Matrix" << endl;
	pad(inputMat2, resultRows);
	initMat(inputMat2, mat2Rows, mat2cols);
	displayMat(inputMat2, resultRows, resultRows);
